...
This is the companion repositor for [our paper](link/archive) titled "Deep learning for time series classification: a review". 

## Data 
The data used in this project coms from two sources: 
